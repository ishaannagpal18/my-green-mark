...
const stats = [
  { label: 'Trees Planted', value: 42500, suffix: '+', icon: '🌳', description: 'Across India', color: '#D6E8D2', accentColor: '#06402B' },
  { label: 'CO₂ Offset', value: 8200, suffix: ' T', icon: '🌍', description: 'Tonnes reduced', color: '#D6E8D2', accentColor: '#06402B' },
  ...
  { label: 'Carbon Credits', value: 4800, suffix: '', icon: '♻️', description: 'Traded on platform', color: '#D6E8D2', accentColor: '#06402B' },
]
    ...
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#06402B]">Our Impact in Numbers</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
          {stats.map((stat, i) => (
            ...
            >
              ...
              {/* Number */}
              <div className="text-3xl sm:text-4xl font-black text-[#06402B] mb-1 tabular-nums">
                <Counter target={stat.value} suffix={stat.suffix} />
              </div>
              <div className="font-bold text-[#06402B] text-sm mb-1">{stat.label}</div>
        ...
        {/* Market strip */}
        <div className="mt-14 relative overflow-hidden bg-gradient-to-r from-[#06402B] via-[#06402B] to-[#06402B] rounded-2xl p-6 text-white text-center shadow-xl">
