...
export default function ContactCTA() {
  return (
    <section className="py-20 bg-forest-deep relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-80 h-80 bg-[#14532D]/40 rounded-full -translate-y-1/2 translate-x-1/2 blur-3xl pointer-events-none"></div>
            ...
            <div className="glass-dark border border-white/20 rounded-2xl p-8 shadow-2xl">
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full bg-[#14532D] border border-white/20 text-white rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#F4B942] focus:ring-1 focus:ring-[#F4B942]/30 transition-all">
