...
const services = [
  ...
  },
  {
    ...
    description: 'Sustainability awareness through gamified competitions, school programs, workshops & community campaigns — including the Green Talent Hunt 2026.',
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <Scroll3DReveal direction="up">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#06402B] mb-4">
              Five Integrated Service Pillars
            </h2>
            <p className="text-[#06402B] text-lg max-w-2xl mx-auto">
              ...
              <TiltCard className="h-full" intensity={8}>
                ...
                >
                  <div className="flex items-start justify-between mb-5">
                    ...
                    <span className="text-4xl font-black text-[#D6E8D2]">{service.number}</span>
                  </div>

                  <h3 className="font-bold text-[#06402B] text-xl mb-1">{service.title}</h3>
                  <p className="text-[#3A8A5C] text-xs font-semibold mb-3">{service.tagline}</p>
                  <p className="text-[#06402B] text-sm leading-relaxed mb-5">{service.description}</p>
                  ...
                  <div className="flex items-center gap-2 text-[#06402B] text-sm font-semibold group-hover:text-[#3A8A5C] transition-colors mt-auto">
                    Learn more
